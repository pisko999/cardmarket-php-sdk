...
final class CartResource extends ModelMultipleResource
{
    ...
    {
        return ($this->entity instanceof $this->className) ? $this->entity->setAction($action) : false;
    }

    public function getAction(): ?string
    {
        return ($this->entity instanceof $this->className) ? $this->entity->getAction() : null;
    }
